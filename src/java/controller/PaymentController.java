...
public class PaymentController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        String selectedPackage = request.getParameter("selectedPackage"); // ví dụ: Gói 1 tuần - 19000

String amount = "";
if (selectedPackage != null && selectedPackage.contains("-")) {
    String[] parts = selectedPackage.split("-");
    amount = parts[1].trim(); // "19000"
}
