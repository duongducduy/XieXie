...
public class TaskController extends HttpServlet {
    ...
    // Nếu có user trong session → xử lý hiển thị nhiệm vụ
    TaskDAO dao = new TaskDAO();
    List<Task> missions = dao.getTasksByUserToday(user.getUserId());

    System.out.println("User ID: " + user.getUserId());
    System.out.println("Số lượng nhiệm vụ: " + missions.size());
