...
try {
    ...
    if (user == null) {
        ...
        user.setImage("default.png"); // hoặc userInfo.getString("picture") nếu có avatar

        // Lưu user vào DB
        dao.createUserFromGoogle(user); // bạn cần viết hàm này trong UserDAO

        System.out.println("New user created from Google account");
    }
